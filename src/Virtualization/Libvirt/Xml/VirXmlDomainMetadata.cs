...
{
    [Serializable]
    [XmlRoot(ElementName = "metadata", Namespace = "")]
    public class VirXmlDomainMetadata
    {
        [XmlElement("libosinfo", Namespace = VirXmlNamespace.LIBOSINFO)]
        public VirXmlDomainLibOSInfo LibOSInfo { get; set; }
    }
}
