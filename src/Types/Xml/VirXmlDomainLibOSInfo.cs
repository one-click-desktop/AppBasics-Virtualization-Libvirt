...
{
    [Serializable]
    [XmlRoot(ElementName = "libosinfo", Namespace = VirXmlNamespace.LIBOSINFO)]
    public class VirXmlDomainLibOSInfo
    {
        [XmlElement("os", Namespace = VirXmlNamespace.LIBOSINFO)]
        public VirXmlAddressType OS { get; set; }
    }
}
